...
<body class="overflow-x-hidden">
    ...
    <!-- LEAD VISUAL -->
    <div class="bg-no-repeat bg-top bg-cover rounded h-[480px]" style="background-image: url('./../../resources/uploads/contents/<?= ($leadVisual) ?>');">
        <div class="flex flex-col-reverse h-full pb-8 rounded bg-gradient-to-t from-gray-900">

            <?php include './../components/pageHeader_features.php'; ?>
