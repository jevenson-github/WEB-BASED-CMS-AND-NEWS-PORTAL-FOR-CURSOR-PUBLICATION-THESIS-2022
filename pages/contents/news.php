...
<body class="overflow-x-hidden">
    ...
    <!-- HEADER CONTENT -->
    <?php include './../components/pageHeader_news.php'; ?>

    <div class="max-w-screen-xl mx-auto">

        <div class="mt-8 aspect-w-2 aspect-h-1">
            <img class="object-cover object-top xl:rounded-lg" src="./../../resources/uploads/contents/<?= ($leadVisual) ?>" />
        </div>
