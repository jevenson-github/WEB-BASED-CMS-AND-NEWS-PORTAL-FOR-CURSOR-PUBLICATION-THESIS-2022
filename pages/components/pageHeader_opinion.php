...
<div class="w-full py-8 bg-amber-500">
    <div class="block w-full max-w-screen-xl mx-auto">
        ...
        <div class="flex flex-col px-8 md:flex-row gap-y-8">
            <article class="mt-8 prose prose-lead:text-white prose-lead:font-medium h-fit max-w-prose prose-lead:text-2xl md:prose-lead:3xl prose-lead:leading-snug">
                <h2 class="lead"><?= $leadText ?></h2>
            </article>
            <div class="flex flex-col w-full max-w-screen-xl px-10">
