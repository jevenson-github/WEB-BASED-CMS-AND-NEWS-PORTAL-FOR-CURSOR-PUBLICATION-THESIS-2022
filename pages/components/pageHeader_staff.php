...
if ($bio == null) {
    $bio = "This staff member has not written a bio yet.";
}
...
<div class="h-full bg-center bg-no-repeat bg-cover">
    <div class="flex flex-col h-full bg-gradient-to-b from-amber-500 via-white">
        ...
        <div class="flex flex-col-reverse w-full max-w-screen-xl mx-auto">
            ...
            <div class="mx-8">
                ...
                <div>
                    ...
                    <img class="w-32 h-32 rounded-full" src="./../resources/uploads/editorial-board/<?= $image ?>">
                    <h5 class="mt-4 font-semibold tracking-widest uppercase rounded-full text-amber-500"><?= $position ?></h5>
                    <h1 class="mt-1 text-5xl font-bold text-gray-900"><?= $name ?></h1>
                    
                    <p class="mt-4 text-gray-700"><?= $bio ?></p>
                    
                </div>

                <div class="flex flex-row mt-8 gap-x-2">
                    <button id="btn_shareFB" type="button" class="inline-flex items-center p-1 transition bg-gray-100 border border-transparent rounded-full text-amber-600 hover:bg-amber-600 hover:text-white">
                    ...
                    <button id="btn_shareTW" type="button" class="inline-flex items-center p-1 transition bg-gray-100 border border-transparent rounded-full text-amber-600 hover:bg-amber-600 hover:text-white">
                        <svg width="30" height="30" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button id="btn_shareCL" type="button" class="inline-flex items-center p-1 transition bg-gray-100 border border-transparent rounded-full text-amber-600 hover:bg-amber-600 hover:text-white">
                        <svg width="30" height="30" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
